...
return [
    ...
    'show_bank_list' => [
        ...
        2 => [
            'icon_name' => 'bank_xingye',
            'bankName' => "兴业银行激活版",
            'settlement_rule' => '新户首次申请兴业银行信用卡，资料审批通过收到核卡短信后到银行网点面签激活卡片算成功办理此业务。<br>【注】**自申请之日起超30天未激活视为订单未完成，不予结算激活佣金',
            'settlement_cycle' => '新户激活T+2结算',
            'bank_feature' => '首年免年费',
            'bank_card' => 'bank_card_xingye.png',
        ...
        4 => [
            ...
            'icon_name' => 'bank_guangfa',
            'bankName' => "广发银行激活版",
            'settlement_rule' => '【结算规则】<br>新户首次申请广发银行信用卡，资料审批通过收到核卡短信后到银行网点面签激活卡片算成功办理此业务。<br>【注】此卡为白金卡，申请资质不够将自动降普卡金卡，不影响自动正常结算',
            'settlement_cycle' => '新户激活T+2结算',
            'bank_feature' => '首年免年费',
            'bank_card' => 'bank_card_guangfa.jpeg',
            'credit_card_name' => '广发运通卡',
            'settle_type' => '激活',
            'money_one' => 170,
            'money_two' => 0,
            'money_late' => 0,
        ...
        7 => [
            'icon_name' => 'bank_pufa',
            'bankName' => "浦发银行激活版",
            'settlement_rule' => '新户首次申请浦发银行信用卡，资料审批通过收到核卡短信后激活卡片算成功办理此业务。<br>【注】<br>**自申请之日起30天内未激活视为订单未完成，不予发放奖励。<br>**自申请之日起90天内注销卡将扣除佣金。',
            'settlement_cycle' => '新户激活每周一结算',
            'bank_feature' => '刷卡免年费',
            'bank_card' => 'bank_card_pufa.jpeg',
            'credit_card_name' => '浦发银行京东联名卡',
            'settle_type' => '激活',
            'money_one' => 130,
            'money_two' => 0,
            'money_late' => 0,
        ...
        8 => [
            ...
            'bankName' => "中原核卡",
            'settlement_rule' => '新户首次申请中原银行信用卡，资料审批通过收到核卡短信算成功办理此业务。<br>【注意】*为避免影响结算，在填写信息过程中请勿退出页面，退出后重新填写将导致订单信息失效<br>***60天内注销卡片奖励佣金收回',
            'settlement_cycle' => '新户核卡实时结算',
            'bank_feature' => '金卡待遇',
            'bank_card' => 'bank_card_zhongyuan.jpeg',
            'credit_card_name' => '中原银行京东联名卡',
            'settle_type' => '核卡',
            'money_one' => 100,
            'money_two' => 0,
            'money_late' => 0,
        ...
        10 => [
            ...
            'api_bank_id' => "11",
            'show_money' => '100',
            'poster_url' => 'poster_bank_tianjing.png',
        ],
        11 => [
            'icon_name' => 'bank_nbyh',
            'bankName' => "宁波京东激活版",
            'settlement_rule' => '新户首次申请宁波银行信用卡，资料审批通过后收到核卡短信后激活卡片算成功办理此业务。<br>【可申请区域】<br>上海、杭州、南京、深圳、苏州、北京、无锡、温州、金华、\n绍兴、台州、嘉兴、丽水、湖州、衢州、舟山、宁波',
            'settlement_cycle' => '新户激活T+2结算',
            'bank_feature' => '周周减宁波版',
        ...
        14 => [
            'icon_name' => 'bank_zhengzhou',
            'bankName' => "郑州银行核卡版",
            'settlement_rule' => '新户首次申请郑州银行信用卡，资料审批通过收到核卡短信算成功办理此业务。',
            'settlement_cycle' => '新户核卡每T+1结算',
            'bank_feature' => '首刷有礼，高颜值',
            'bank_card' => 'bank_card_zhengzhou.png',
            'credit_card_name' => '郑州京东联名卡',
            'settle_type' => '核卡',
            'money_one' => 60,
            'money_two' => 0,
            'money_late' => 0,
        ...
        17 => [ // 齐鲁激活
            'icon_name' => 'bank_qilu',
            'bankName' => "齐鲁银行激活版",
            'settlement_rule' => '新户首次申请齐鲁银行信用卡，资料审批通过收到核卡短信后到银行网点面签激活卡片算成功办理此业务。<br>【注】**自申请之日起超30天未激活视为订单未完成，不予结算激活佣金',
            'settlement_cycle' => '新户激活T+2结算',
            'bank_feature' => '首年免年费',
            'bank_card' => 'bank_card_qilu.jpeg',
            'credit_card_name' => '齐鲁京东联名卡',
            'settle_type' => '激活',
            'money_one' => 70,
            'money_two' => 0,
            'money_late' => 0,
    ...
    'show_bank_list2' => [
        ...
        1 => [
            'icon_name' => 'bank_zxyh',
            'bankName' => "中信银行首刷版",
            'settlement_rule' => '新户首次申请中信银行信用卡，审批通过后，申请核卡通过，用户主动拿身份证去网点面签激活后（首刷需用户主动去网点面签激活），任意消费一笔金额算即为成功办理此业务。<br>申请套卡或者申请外币卡不结算奖励。<br>①自申请之日起15天内完成首刷的，奖励300元；<br>②自申请之日起16天-30天内完成首刷的，奖励为120元；<br>③申请之日起超过30天未首刷的，不结算奖励.<br>首刷数据3个工作日内返回<br>【注】<br>**自申请之日起30天内未首刷视为订单未完成，不予发放奖励。<br>***60天内注销卡片奖励佣金收回<br>【重要提醒】：<br>①必须客户本人亲自去银行网点完成激活，电话激活，短信回访激活或者客户经理上门激活等都不予结算佣金；<br>②申请时预留的姓名，手机号 ，身份证号必须跟线下面签的一致，否则无法统计到业绩；<br>③注意面签的时候不要重新办卡，个别支行会要求重新办，重新办卡会导致无法返佣金！<br>*推广人需特别注意！！！以下几点均【无法结算】：<br>①如收到两张中信信用卡，请使用申卡时选择的卡种进行激活首刷，否则会导致无法结算！<br>②客户实名未通过（申请人手机号实名和身份证信息不一致）转为卡员上门办理的；<br>③180天内有过中信申请记录且初审通过；<br>④30天内没去网点面签转为卡员上门办理；<br>⑤客户去网点面签时重新办卡；',
            'settlement_cycle' => '新户首刷T+1更新',
            'bank_feature' => '刷卡免年费',
            'bank_card' => 'bank_card_zxyh.png',
            'credit_card_name' => '中信银行信用卡',
            'settle_type' => '首刷',
        ...
        5 => [
            'icon_name' => 'bank_gzhou',
            'bankName' => "广州核卡",
            'settlement_rule' => '新户首次首次申请广州银行信用卡，资料审批通过后收到核卡短信算成功办理此业务。<br> 【有效投放地区】：广州、深圳、东莞、佛山、清远、珠海、肇庆、江门、惠州、中山、汕头，韶关<br>***60天内注销卡片奖励佣金收回',
            'settlement_cycle' => '新户核卡T+1结算',
            'bank_feature' => '首刷送好礼',
            'bank_card' => 'bank_card_gzhou.jpeg',
            'credit_card_name' => '广州银行信用卡',
            'settle_type' => '核卡',
            'money_one' => 130,
            'money_two' => 0,
            'money_late' => 0,
            ...
            'api_bank_id' => "5",
            'show_money' => '130',
            'poster_url' => 'poster_bank_guangzhou.png',
        ],
        6 => [
            'icon_name' => 'bank_sjyh',
            'bankName' => "盛京核卡",
        ...
        11 => [
            'icon_name' => 'bank_jxyh',
            'bankName' => "江西银行激活版",
            'settlement_rule' => '新户首次申请江西银行信用卡，资料审批通过后收到核卡短信后激活卡片算成功办理此业务。',
        ...
        16 => [
            'icon_name' => 'bank_jilin',
            'bankName' => "吉林核卡",
            'settlement_rule' => '新户首次申请吉林银行信用卡，资料审批通过后收到下卡短信算成功办理此业务。',
            'settlement_cycle' => '新户核卡T+1结算',
            'bank_feature' => '最高10万元额度',
            'bank_card' => 'bank_card_jilin.png',
            'credit_card_name' => '吉林京东联名信用卡',
            'settle_type' => '核卡',
            'money_one' => 100,
            'money_two' => 0,
            'money_late' => 0,
            ...
            'api_bank_id' => "11",
            'show_money' => '100',
            'poster_url' => 'poster_bank_jilin.png',
        ],
        17 => [
            'icon_name' => 'bank_nbyh',
            'bankName' => "宁波京东激活版",
